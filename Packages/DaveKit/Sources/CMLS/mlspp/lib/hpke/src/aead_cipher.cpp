...
cipher_key_size(AEAD::ID cipher)
{
  switch (cipher) {
    ...
    default:
      throw std::runtime_error("Unsupported AEAD key-size algorithm");
  }
}
...
cipher_nonce_size(AEAD::ID cipher)
{
  switch (cipher) {
    ...
    default:
      throw std::runtime_error("Unsupported AEAD nonce-size algorithm");
  }
}
...
cipher_tag_size(AEAD::ID cipher)
{
  switch (cipher) {
    ...
    default:
      throw std::runtime_error("Unsupported AEAD tag-size algorithm");
  }
}
...
boringssl_cipher(AEAD::ID cipher)
{
  switch (cipher) {
    ...
    default:
      throw std::runtime_error("Unsupported BoringSSL AEAD algorithm");
  }
}
#else
...
openssl_cipher(AEAD::ID cipher)
{
  switch (cipher) {
    ...
    default:
      throw std::runtime_error("Unsupported OpenSSL AEAD algorithm");
  }
}
